...
@section('content')
    ...
    <div class="card" id="jobContractsList">
        <div class="card-header border-bottom-dashed">
            <div class="row g-4 align-items-center">
                <div class="col-sm">
                    <div>
                        <h5 class="card-title mb-0">Job Contract List</h5>
                    </div>
                </div>
                <div class="col-sm-auto">
                    <div class="d-flex flex-wrap align-items-start gap-2">
                        ...
                        <a href="{{ route('job-contracts.create') }}" class="btn btn-primary""><i
                                class="ri-add-line align-bottom me-1"></i> Add Job Contract</a>
                ...
                <div class="row g-3">
                    <div class="col-xl-6">
                        <div class="search-box">
                            <input type="text" class="form-control" id="job-contract-search"
                                placeholder="Search Job Contract">
        ...
        <div class="card-body">
            <div class="table-responsive-xl table-card mb-1">
                <table class="table align-middle w-100" id="job-contracts-table">
                    <thead class="table-light text-muted">
                        <tr>
                            <th class="sort">Id</th>
                            <th class="sort">Contract Code Number</th>
                            <th class="sort">Worker</th>
                            <th class="sort">Client</th>
                            <th class="sort">Contract Amount</th>
...
@push('scripts')
    <script>
        $('#job-contracts-table').on('draw.dt', function() {
        ...
        function initializeTables() {
            let columns = [{
                ...
                {
                    data: "contract_code_number",
                    name: "contract_code_number",
                },
                {
                    data: "worker",
                    name: "worker",
            ...
            let table = $("#job-contracts-table").DataTable({
                processing: true,
                searching: false,
                lengthChange: false,
                ordering: false,
