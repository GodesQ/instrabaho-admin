...
@section('content')
    ...
    <div class="card" id="jobProposalList">
        <div class="card-header border-bottom-dashed">
            <div class="row g-4 align-items-center">
                <div class="col-sm">
                    <div>
                        <h5 class="card-title mb-0">Job Proposals</h5>
                    </div>
                </div>
                <div class="col-sm-auto">
                    <div class="d-flex flex-wrap align-items-start gap-2">
                        ...
                        <a href="{{ route('job-proposals.create') }}" class="btn btn-primary""><i
                                class="ri-add-line align-bottom me-1"></i> Add Job Proposals</a>
                        <button type="button" class="btn btn-secondary">
                            <i class="ri-file-download-line align-bottom me-1"></i> Export as CSV
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="card-body">
            <div class="table-responsive-xl table-card mb-1">
                <table class="table align-middle w-100" id="job-proposals-table">
                    <thead class="table-light text-muted">
                        <tr>
                            <th class="sort">Id</th>
                            <th class="sort">Worker</th>
                            <th class="sort">Job Post</th>
                            <th class="sort">Offer Amount</th>
...
@push('scripts')
    <script>
        $('#job-proposals-table').on('draw.dt', function() {
        ...
        function initializeTables() {
            ...
            let table = $("#job-proposals-table").DataTable({
                processing: true,
                searching: false,
                lengthChange: false,
                ordering: false,
