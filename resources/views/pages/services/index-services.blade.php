    ...
    <div class="card" id="serviceCategoriesList">
            ...
            <div class="row g-4 align-items-center">
                ...
                <div class="col-sm-auto">
                    <div class="d-flex flex-wrap align-items-start gap-2">
                        ...
                        <a href="{{ route('job-services.create') }}" class="btn btn-primary""><i
        ...
        <div class="card-body">
            <div class="table-responsive-xl table-card mb-1">
                <table class="table align-middle w-100" id="services-table">
                    <thead class="table-light text-muted">
                        <tr>
                            <th class="sort" data-sort="id">Id</th>
                            <th class="sort" data-sort="service_category">Service Category</th>
                            <th class="sort" data-sort="service_type">Title</th>
...
@push('scripts')
    <script>
        $('#services-table').on('draw.dt', function() {
