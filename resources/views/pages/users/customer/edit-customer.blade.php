    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="vertical-navs-step form-steps" method="POST" novalidate id="worker-form"
                action="{{ route('backend.customers.update', $user->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="row gy-5">
                    <div class="col-lg-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" data-plugin="choices" data-choices
                                                    ...
                                                    <option
                                                        {{ ($user->customer_details->customer_type ?? null) == 'Individual' ? 'selected' : null }}
                                                        value="Individual">Individual</option>
                                                    <option
                                                        {{ ($user->customer_details->customer_type ?? null) == 'Business' ? 'selected' : null }}
                                        ...
                                        <div class="col-md-6 customer-individual-grp">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="facebook-url-field"
                                                    ...
                                                    value="{{ $user->customer_details->facebook_url ?? null }}">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 customer-individual-grp">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="occupation-field"
                                                    ...
                                                    value="{{ $user->customer_details->occupation ?? null }}">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 customer-business-grp">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="company-name-field"
                                                    name="company_name"
                                                    value="{{ $user->customer_details->company_name ?? null }}">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 customer-business-grp">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="company-website-field"
                                                    ...
                                                    value="{{ $user->customer_details->company_website ?? null }}">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 customer-business-grp">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="industry-field"
                                                    name="industy"
                                                    value="{{ $user->customer_details->industry ?? null }}">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                    </div>
