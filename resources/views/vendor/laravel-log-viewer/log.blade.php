...
<head>
  ...
  <title>Instrabaho Log Viewer</title>
  <link rel="stylesheet"
...
<div class="container-fluid">
  <div class="row">
    <div class="col sidebar mb-3">
      ...
      <div class="custom-control custom-switch" style="padding-bottom:20px; margin-top: 20px;">
    ...
    <div class="col-10 table-container">
        <div class="card ">
            <div class="card-header d-flex justify-content-start">
                <a href="{{ route('dashboard') }}" class="btn btn-primary text-white">
                    <i class="bi bi-arrow-bar-left"></i> Back to Dashboard
                </a>
            </div>
            <div class="card-body">
                @if ($logs === null)
